...
WebUI.setText(findTestObject('Object Repository/Page_Login  Kotakoki/input_Username or E-mail_username-298'), GlobalVariable.username)

WebUI.setText(findTestObject('Object Repository/Page_Login  Kotakoki/input_Password_user_password-298'), 'itIsNotMyPassword')
